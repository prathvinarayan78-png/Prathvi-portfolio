    ...
    <section className="px-4 md:px-8 py-20 md:py-28">
      <div className="flex items-end justify-between mb-16 md:mb-24">
        <h2 className="mega text-[clamp(2.6rem,9vw,8rem)] relative">
          <span aria-hidden className="num-ghost mega absolute -top-6 md:-top-10 left-0 text-[clamp(1.6rem,4vw,3rem)]">/05</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
        {CELLS.map((c) => (
          <div
            key={c.t}
            className="cell aspect-[4/3] md:aspect-[16/9] flex flex-col justify-between p-4 md:p-6 cursor-crosshair"
